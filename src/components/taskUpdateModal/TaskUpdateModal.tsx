...
const TaskUpdateModal = ({ activeEditTask, setActiveEditTask, setIsTaskEditModalOpen, tasks, setTasks }: TaskUpdateModalParams) => {
    ...
    return (
        <div className="task-update-modal">
            ...
            <div className="task-update-modal__foreground">
                <button onClick={() => setIsTaskEditModalOpen(false)}>X</button>
